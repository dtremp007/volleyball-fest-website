...
beforeEach(async () => {
  ...
  await client.executeMultiple(`
    ...
    CREATE TABLE category (id text PRIMARY KEY, name text NOT NULL, description text NOT NULL, playoff_format text DEFAULT 'top-4' NOT NULL, color text DEFAULT '#374151' NOT NULL, meetings_per_pair integer DEFAULT 1 NOT NULL);
    ...
    INSERT INTO category VALUES ('category', 'Mixed', 'Mixed league', 'top-4', '#374151', 1);
