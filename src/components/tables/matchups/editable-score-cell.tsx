...
export function EditableScoreCell({ row, table, teamKey }: Props) {
  ...
  const score = teamKey === "teamA" ? original.teamAScore : original.teamBScore;
  ...
  return (
    <input
      ...
      className="focus:bg-primary/10 focus:ring-primary h-8 w-14 rounded-none border bg-transparent px-1 text-center tabular-nums outline-none focus:ring-1"
      value={localValue}
